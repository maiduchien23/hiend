...
exports.vacationPhotoContestProcessError = (req, res, fields, files) => {
    res.render(303, '/contests/vation-photo-error')
}
exports.vacationPhotoContestProcessThankyou = (reg, res) => {
...
// argumatns, so we have to disable ESLint's no-unused-vars rule
/* eslint-disable no-unused-vars */
export.serverError = (err, req, res, next) => res.render('500')
